...
@interface ZKChattingMainViewController : ZKBaseTableViewController<UITextViewDelegate,JSMessageInputViewDelegate,UIScrollViewDelegate,UIGestureRecognizerDelegate,UIAlertViewDelegate,UINavigationControllerDelegate>{
