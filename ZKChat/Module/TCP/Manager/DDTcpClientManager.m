...
-(void)disconnect
{
    ...
    [ZKNotification postNotification:DDNotificationTcpLinkDisconnect userInfo:nil object:nil];
...
- (void)p_handleConntectOpenCompletedStream:(NSStream *)aStream
{
    ...
    if (aStream == _outStream) {
        [ZKNotification postNotification:DDNotificationTcpLinkConnectComplete userInfo:nil object:nil];
    ...
    if (aStream) {
        ...
        if (len > 0) {
            ...
            while ([_receiveBuffer length] >= 16) {
                ...
                [ZKNotification postNotification:DDNotificationServerHeartBeat userInfo:nil object:nil];
