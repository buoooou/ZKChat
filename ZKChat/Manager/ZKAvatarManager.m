...
@interface ZKAvatarManager(PrivateAPI)
...
@end
@implementation ZKAvatarManager
{
...
{
    static ZKAvatarManager* g_avatarManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        g_avatarManager = [[ZKAvatarManager alloc] init];
    });
...
- (void)p_startOneGroupAvatarCombination
{
    if ([_avatars count] > 0 && !_currentAvatarKey)
    {
        ...
        __weak ZKAvatarManager* weakSelf = self;
